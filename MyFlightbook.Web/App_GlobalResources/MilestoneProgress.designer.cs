...
namespace Resources {
    ...
    internal class MilestoneProgress {
        ...
        /// <summary>
        ///   Looks up a localized string similar to ADDITIONAL NOTES:&lt;ul&gt;&lt;li&gt;Part 141 for multi-engine aircraft requires &quot;performing the duties of a pilot in command while under the supervision of a certificated flight instructor&quot; rather than solo.  You can specify this for a flight by indicating Duties of PIC (&quot;DPIC&quot;) time and that the flight had an Instructor On Board (in additional properties).&lt;/li&gt;&lt;li&gt;DPIC is distinct from dual received, so any dual time logged on such a flight that overlaps with DPIC time is not counted.&lt;/li&gt;&lt;/ul&gt;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 10 takeoffs &amp; landings in a {0}.
        /// </summary>
